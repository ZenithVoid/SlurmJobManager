...
public class SbatchJobOptions
{
    ...
    public string GpuCount { get; set; } = string.Empty;
...
public class CommandEntry
{
    ...
    /// <summary>Environment variables applied only to this command line.</summary>
    public List<EnvironmentVariableEntry> EnvironmentVariables { get; set; } = new();

    /// <summary>Optional Python interpreter used to launch <see cref="ProgramPath"/> as a script.</summary>
    public string? PythonInterpreterPath { get; set; }

    /// <summary>Whether this command should be launched through the selected Python interpreter.</summary>
    public bool UsePythonInterpreter { get; set; }
