...
public partial class JobNotificationWindow : Window
{
    ...
    public void MoveToStackIndex(int stackIndex, bool animate)
    {
        if (_isClosing)
            return;
    ...
    private static double CalculateTop(int stackIndex)
    {
        var workArea = SystemParameters.WorkArea;
        return workArea.Bottom - NotificationHeight - EdgeMargin - (Math.Max(0, stackIndex) * (NotificationHeight + StackGap));
    }
