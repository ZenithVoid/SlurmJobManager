...
public sealed class SettingsViewModel : ViewModelBase
{
    ...
    private const string GitHubReleasesPage = "https://github.com/ZenithVoid/SlurmPilot/releases";
    private const string GitHubRepositoryPage = "https://github.com/ZenithVoid/SlurmPilot";
        ...
        IAppLogger? logger = null)
    {
        ...
        _main.Monitor.PropertyChanged += OnMonitorPropertyChanged;
    }
    ...
    {
        get => _prefs.JobMonitorNotificationMode switch
        {
            JobMonitorNotificationMode.Windows => 1,
            JobMonitorNotificationMode.AppWidget => 2,
            _ => 0,
        };
        set
        {
            ...
            {
                1 => JobMonitorNotificationMode.Windows,
                2 => JobMonitorNotificationMode.AppWidget,
                _ => JobMonitorNotificationMode.None,
            };
            ...
            OnPropertyChanged();
            OnPropertyChanged(nameof(IsJobMonitorNotificationPersistentEnabled));
    ...
    public bool JobMonitorNotificationPersistent
    {
        ...
        set
        {
            if (!IsJobMonitorNotificationPersistentEnabled)
            {
                OnPropertyChanged();
                return;
            }
    ...
    public bool IsJobMonitorNotificationPersistentEnabled => _prefs.JobMonitorNotificationMode != JobMonitorNotificationMode.None;

    public bool IsJobMonitorNotificationDurationEnabled
        => IsJobMonitorNotificationPersistentEnabled && !JobMonitorNotificationPersistent;
    ...
    {
        if (e.PropertyName is nameof(MonitorViewModel.ShowAllUsers))
            OnPropertyChanged(nameof(MonitorAllUsersJobs));
    }
    ...
    private void ExportLogs()
    {
        ...
        {
            _logFileService.EnsureLogsDirectory();
            var defaultZipName = $"SlurmPilot-logs-{DateTime.UtcNow:yyyyMMdd-HHmmss}.zip";
