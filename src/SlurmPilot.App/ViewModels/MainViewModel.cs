...
public sealed class MainViewModel : ViewModelBase
{
    ...
    public void ApplyLocale(string locale)
    {
        ...
        var locUri = new Uri(
            $"pack://application:,,,/SlurmPilot.App;component/Localization/Strings.{locale}.xaml");
    ...
    private static void ApplyTheme(bool dark)
    {
        ...
        var dicts = app.Resources.MergedDictionaries;
        var themeUri = dark
            ? new Uri("pack://application:,,,/SlurmPilot.App;component/Themes/Dark.xaml")
            : new Uri("pack://application:,,,/SlurmPilot.App;component/Themes/Light.xaml");
